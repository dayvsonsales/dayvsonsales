...
- 💼 I have experience with software development working on range from frontend (basic level) to backend and DevOps too (in a very junior level).  My last project was [Projeto TATU](https://projetotatu.com.br) (in Portuguese), an accessibility project for tourism using IoT (with beacons) technology.
